  ...
  return (
    <nav
      className={cn(
        ...
        scrollHeight > 200
          ? " fixed backdrop-blur-xl top-0 left-0  z-50 -translate-y-28 opacity-0 animate-slideDown bg-white-main/90 dark:bg-gray-900/90 py-2 border-b border-gray-200 shadow-md"
          : "sm:py-6 py-4",
        {
