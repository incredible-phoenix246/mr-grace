  ...
  return (
    ...
    >
      <div className="flex flex-col w-full h-full items-center justify-center space-y-6 md:space-y-9">
        <p className="text-[24px] md:text-[32px] lg:text-[52px] leading-[52px] font-poppins w-[70%] font-bold text-center text-white-main">
        ...
        <div className="flex items-center">
          ...
          />
          <Button
            className="ml-4 h-[35px] lg:h-[56px] w-[109px] lg:w-[166px]"
            variant={"outline"}
          >
            Get Started
          </Button>
        ...
        <p className="text-center text-base w-[30%] text-white-main">
